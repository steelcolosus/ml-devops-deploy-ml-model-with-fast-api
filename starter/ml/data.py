...
def clean_data(file_path):
    """
    Cleans the data in the given file by removing all spaces.
    ...
    -------
    data : pd.DataFrame
        Cleaned data in a pandas DataFrame.
    """
...
def process_data(
    ...
    features and a label binarizer for the labels. This can be used in either
